...
const NEW_IMAGES = [
  { file: 'vigilante.jpg', key: 'vigilante' },
  { file: 'consigliere.jpg', key: 'consigliere' },
  { file: 'mayor.jpg', key: 'mayor' },
  { file: 'mortician.jpg', key: 'mortician' }
];
...
async function main() {
  ...
  const roleImgInsert = 'Vigilante:IMG.vigilante, Consigliere:IMG.consigliere, Mayor:IMG.mayor, Mortician:IMG.mortician, ';
